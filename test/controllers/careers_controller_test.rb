...
class CareersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create career" do
    assert_difference('Career.count') do
      post careers_url, params: { career: { name: @career.name, year_duration: @career.year_duration } }
    end
  ...
  test "should update career" do
    patch career_url(@career), params: { career: { name: @career.name, year_duration: @career.year_duration } }
