...
class EvaluationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evaluation" do
    assert_difference('Evaluation.count') do
      post evaluations_url, params: { evaluation: { credit: @evaluation.credit, teacher_id: @evaluation.teacher_id, user_id: @evaluation.user_id } }
    end
  ...
  test "should update evaluation" do
    patch evaluation_url(@evaluation), params: { evaluation: { credit: @evaluation.credit, teacher_id: @evaluation.teacher_id, user_id: @evaluation.user_id } }
